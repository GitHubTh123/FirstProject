...
<head>
    ...
    <script type="text/javascript">
        ...
        function customerRemark() {
            $.ajax({
                url: "workbench/customer/customerRemark.do",
                data: {
                    "customerId": "${c.id}"
                },
                dataType: "json",
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.name}</b> <small style="color: gray;"> ' + (n.editFlag == 0 ? n.createTime : n.editTime) + ' 由' + (n.editFlag == 0 ? n.createBy : n.editBy) + '</small>'
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">'
                        html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>'
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;'
                        html += '<a class="myHref" onclick="deleteCustomerRemark(\'' + n.id + '\')" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>'
                        html += '</div>'
                        html += '</div>'
                        html += '</div>'
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            html += '<font color="gray">联系人</font> <font color="gray">-</font> <b>${c.name}</b> <small style="color: gray;"> ' + data.c.createTime + ' 由' + data.c.createBy + '</small>'
                            html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">'
                            html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>'
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;'
                            html += '<a class="myHref" onclick="deleteCustomerRemark(\'' + data.c.id + '\')" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>'
                            html += '</div>'
                            html += '</div>'
                            html += '</div>'
            ...
            $("#customerBody").on("mouseover", ".remarkDiv", function () {
                $(this).children("div").children("div").show();
            })
            $("#customerBody").on("mouseout", ".remarkDiv", function () {
                $(this).children("div").children("div").hide();
            })
            customerRemark()
        });
...
<div style="position: relative; top: -70px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 20px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${c.owner}&nbsp;&nbsp;</b><small
...
<!-- 备注 -->
<div id="customerBody" style="position: relative; top: 10px; left: 40px;">
    <div class="page-header">
        <h4>备注</h4>
    </div>
