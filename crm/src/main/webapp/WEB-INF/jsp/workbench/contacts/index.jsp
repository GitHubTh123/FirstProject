...
<head>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html+='<td><a  onclick="toContactsDetail(\''+n.id+'\')" style="text-decoration: none; cursor: pointer;">'+n.fullname+'</a></td>'
        ...
        function toContactsDetail(id){
            window.location.href="workbench/contacts/toDetail.do?id="+id;
        }
