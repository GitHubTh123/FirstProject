...
<head>
    ...
    <script type="text/javascript">
        function realtion() {
            $.ajax({
                url: "workbench/contacts/allRealtion.do",
                dataType: "json",
                data: {
                    "contactsId": "${c.id}"
                },
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<td>' + n.owner + '</td>'
                        html += '<td><a href="javascript:void(0);" onclick="del(\''+n.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
                        html += '</tr>'
        ...
        $(function () {
            ...
            $("#correlation").click(function () {
                ...
                $.ajax({
                    url: "workbench/contacts/correlation.do",
                    data: {
                        "activityId": num.val(),
                        "contactsId": "${c.id}"
                    },
            ...
            $("#searchActivity").keydown(function (event) {
                if (event.keyCode == 13) {
                    $.ajax({
                        url: "workbench/contacts/searchActivity.do",
                        data: {
    ...
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="jiechu">解除</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="bundActivityModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" id="correlation">关联</button>
            </div>
        </div>
    </div>
</div>
