...
<head>
    ...
    <script type="text/javascript">
        ...
        function relationAC() {
            $.ajax({
                url: "clue/relationActivityClue.do",
                data: {
                    "clueId": "${clue.id}"
                },
                dataType: "json",
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<td>' + n.owner + '</td>'
                        html += '<td><a href="javascript:void(0);"  onclick="unRealtion(\'' + n.id + '\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
                        html += '</tr>'
                    })
        ...
        function unRealtion(id) {
            $.ajax({
                url: "clue/unRealtion.do",
                dataType: "json",
                data: {
                    "id": id
                },
        ...
        $(function () {
            ...
            $("#correlation").click(function () {
                ...
                $.ajax({
                    url: "clue/correaltionActivityClue.do",
                    data: {
                        "arr": arr,
                        "clueId": "${clue.id}"
                    },
            ...
            $("#tb").on("click", $("input[name=flag]"), function () {
                $("#check").prop("checked", $("input[name=flag]").length == $("input[name=flag]:checked").length)
            })
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            html += '<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style="color: gray;"> ' + data.c.createTime + ' 由' + data.c.createBy + '</small>'
                            html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">'
                            html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>'
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;'
            ...
            $("#toConvert").click(function(){
                window.location.href="clue/toConvert.do?id=${clue.id}"
            })
    ...
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="correlation">关联</button>
            </div>
        </div>
    </div>
</div>
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" id="toConvert" class="btn btn-default" ;><span class="glyphicon glyphicon-retweet"></span> 转换</button>
...
<div>
    <div style="position: relative; top: 60px; left: 40px;">
        ...
        <div>
            <a href="javascript:void(0);" id="gl"
